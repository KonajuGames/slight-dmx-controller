...
/* local patch: honour a -D override (see SConstruct — we feed a single
   encoder that already emits correct SPS/PPS ids, and the transcoder's
   private bs_t / h264e_bs_* collide with minih264 in one build). */
